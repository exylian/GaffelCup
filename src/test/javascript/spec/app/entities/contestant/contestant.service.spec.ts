...
describe('Service Tests', () => {
    ...
    describe('Contestant Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ContestantService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/contestants/' + 123);
            });
            it('should return Contestant', () => {

                let entity: Contestant;
                service.find(123).subscribe((_entity: Contestant) => {
                    entity = _entity;
                });
